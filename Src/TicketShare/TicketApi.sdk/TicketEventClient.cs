...
public class TicketEventClient
{
    ...
    private const string _searchName = nameof(TicketEventClient);

    public TicketEventClient(HttpClient client, TicketOption ticketMasterOption, ILogger<TicketEventClient> logger)
    {
