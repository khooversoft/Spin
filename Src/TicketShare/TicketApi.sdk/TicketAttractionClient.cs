...
public class TicketAttractionClient
{
    ...
    public TicketAttractionClient(HttpClient client, TicketOption ticketOption, MonitorRate monitorRate, ILogger<TicketEventClient> logger)
    {
