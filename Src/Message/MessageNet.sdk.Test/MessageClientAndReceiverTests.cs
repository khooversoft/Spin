...
//            EndpointId queueId = new EndpointId("main/fe/post");
...
//            MessageHostReceiver messageHost = new MessageHostReceiverBuilder()
//            {
//                LoggerFactory = loggerFactory,
//            }.Build();

//            MessageNodeOption nodeOption = option.Nodes.First(x => (ServiceId)x.ServiceId == (ServiceId)queueId) with { AutoComplete = true };
...
//            messageHost.Start((ServiceId)nodeOption.ServiceId, x =>
//            {
