...
//        public async Task Set(string store, string environment, StorageRecord storageModel, CancellationToken token)
//        {
...
//                "",
//            }
//            .Concat((model.Storage ?? new List<StorageRecord>()).Select(x => x.ToString()));
