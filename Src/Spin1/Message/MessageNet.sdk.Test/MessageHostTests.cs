...
//            resultPacket.Messages.First().Url.Should().Be(feId);
//            resultPacket.Messages.First().From.Should().Be(accountId);
...
//            resultPacket.Messages.Skip(1).First().Url.Should().Be(accountId);
//            resultPacket.Messages.Skip(1).First().From.Should().Be(feId);
