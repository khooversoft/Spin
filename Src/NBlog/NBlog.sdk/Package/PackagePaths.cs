...
public static class PackagePaths
{
    ...
    public static string GetConfigurationPath(string file) => ConfigurationFolder + file.NotEmpty();
    ...
    public static string GetDatalakePath(string path) => path switch
    {
        ...
        string v when v.StartsWith(ConfigurationFolder) => v[ConfigurationFolder.Length..],
