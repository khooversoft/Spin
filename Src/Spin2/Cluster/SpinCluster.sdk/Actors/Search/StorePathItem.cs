...
public class StorePathItem
{
    ...
    [Id(5)] public string ObjectId { get; init; } = null!;
}


public static class StorePathItemExtensions
{
    public static StorePathItem ConvertTo(this DatalakePathItem subject, string objectId)
    {
        subject.NotNull();
        objectId.NotNull();
