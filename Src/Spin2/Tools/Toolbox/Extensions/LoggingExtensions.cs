...
//    public static void LogWarning(this ILogger logger, ScopeContextLocation context, Exception ex, string? message, params object?[] args)
//    {
//        context = context.With(logger);
//        message = ConstructMessage(message);
//        object[] newObjects = AddContext(args, context);

//        logger.LogWarning(message, ex, newObjects);
//    }
