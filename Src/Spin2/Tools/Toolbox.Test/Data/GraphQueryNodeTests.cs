...
public class GraphQueryNodeTests
{
    ...
    {
        QueryResult result = _map.Query().Search("(key=node1) a1");
    ...
    {
        QueryResult result = _map.Query().Search("(name) a1");
    ...
    {
        QueryResult result = _map.Query().Search("('name=marko')");
    ...
    {
        QueryResult result = _map.Query().Search("(tags='name=marko')");
