...
//{
//    public static async Task<Option> Process(GraphMap graphMap, GiNode giNode, GraphTrxContext pContext, ILogger logger)
//    {
//        logger.LogDebug("Process giNode={giNode}, changeType={changeType}", giNode, giNode.ChangeType);
...
//    private static async Task<Option> Add(GraphMap graphMap, GiNode giNode, GraphTrxContext pContext, ILogger logger)
//    {
//        giNode.NotNull();
//        pContext.NotNull();
...
//    private static async Task<Option> Delete(GraphMap graphMap, GiNode giNode, GraphTrxContext pContext, ILogger logger)
//    {
//        giNode.NotNull();
//        pContext.NotNull();
...
//    private static async Task<Option> Set(GraphMap graphMap, GiNode giNode, GraphTrxContext pContext, ILogger logger)
//    {
...
//        logger.LogDebug("Foreign keys fromKey={fromKey}, foreignKeys={foreignKeys}", fromKey, fkTags);
