...
//public class FileStoreActorTests : IClassFixture<ActorClusterFixture>
//{
//    private readonly ActorClusterFixture _actorFixture;
//    public FileStoreActorTests(ActorClusterFixture actorFixture) => _actorFixture = actorFixture.NotNull();
...
//        IFileStoreActor fileStoreActor = _actorFixture.Cluster.Client.GetFileStoreActor(path);
