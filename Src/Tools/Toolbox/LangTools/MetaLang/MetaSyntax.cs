...
[DebuggerDisplay("TerminalSymbol: Name={Name}, Text={Text}, Type={Type}, Index={Index}")]
public sealed record TerminalSymbol : IMetaSyntax, IEquatable<TerminalSymbol>
{
    ...
    public override string ToString() => $"TerminalSymbol [ Name={Name}, Text={Text}, Type={Type}, Index={Index} ]";
}
