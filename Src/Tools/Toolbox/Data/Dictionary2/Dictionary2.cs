...
///// <summary>
///// Data collection with primary index with 0-n number of secondary index ConcurrentIndexedSet
///// </summary>
//public partial class Dictionary2<TKey, TValue> : IEnumerable<TValue>, IDisposable
//    where TKey : notnull
...
//    public Dictionary2(Func<TValue, TKey> keySelector, IEqualityComparer<TKey>? primaryKeyComparer = null)
//    {
//        _keySelector = keySelector.NotNull();

//        _primaryIndex = new(primaryKeyComparer);
//        _secondaryIndexCollection = new();
//    }
