...
//            Option<string> result = _store.TryAdd(path, new Payload(data.ConvertTo(path), data)) switch
//            {
...
//        var result = _store.AddOrUpdate(path, p => new Payload(data.ConvertTo(path), data), (p, current) =>
//        {
...
//            var result = _store.AddOrUpdate(path, x => new Payload(data.ConvertTo(x), data), (x, current) =>
//            {
//                var payload = current with
//                {
//                    Data = data,
