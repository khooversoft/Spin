...
//public sealed class InMemoryFileStore_Old : /*IFileStore, */IEnumerable<KeyValuePair<string, DataETag>>
//{
...
//    public InMemoryFileStore_Old(ILogger<InMemoryFileStore> logger) => _logger = logger.NotNull();
