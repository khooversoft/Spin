...
//public class GraphAddEdgeCommandTests2
//{
...
//        var testClient = GraphTestStartup.CreateGraphTestHost2(copyMap);
//        var newMapOption = await testClient.Execute("add edge from=node7, to=node1, type=newEdgeType, newTags;", NullScopeContext.Instance);
//        newMapOption.IsOk().Should().BeTrue();

//        QueryResult commandResults = newMapOption.Return();
