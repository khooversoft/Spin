...
//        n2 = Set(n2, n1.Key, n1.CreatedDate);

//        (n1 == n2).Should().BeTrue();
//    }

//    private GraphEdge Set(GraphEdge edge, Guid key, DateTime createdDate) => new GraphEdge(key, edge.FromKey, edge.ToKey, edge.EdgeType, edge.Tags, createdDate);
