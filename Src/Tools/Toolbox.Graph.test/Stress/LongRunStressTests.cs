...
//        var context = host.Services.GetRequiredService<ILogger<LongRunStressTests>>();
...
//        {
//            "AddNodes" => AddNodes(graphClient, "n1", token),
//            "AddNodesInBatch" => AddNodesInBatch(graphClient, "nb1", token),
//            "AddEdges" => AddEdges(graphClient, "e1", token),
//            "AddNodesWithTags" => AddNodesWithTags(graphClient, "n2", token),
//            "AddEdgesBatch" => AddEdgesBatch(graphClient, "e2", token),
//            "AddEdgesWithTagsInBatch" => AddEdgesWithTagsInBatch(graphClient, "e3", token),
//            "AddNodesWithData" => AddNodesWithData(graphClient, "n3", token),
...
//        var start = DateTime.Now;
//        Task<int>[] taskList = [
//            AddNodes(graphClient, "n1", token),
//            AddEdges(graphClient, "e1", token),
//            AddNodesWithTags(graphClient, "n2", token),
//            AddNodesWithData(graphClient, "n3", token),

//            AddNodesInBatch(graphClient, "nb1", token),
//            AddEdgesBatch(graphClient, "e2", token),
//            AddEdgesWithTagsInBatch(graphClient, "e3", token),
//            ];
...
//    private async Task<int> AddNodes(IGraphClient graphClient, string prefix, CancellationToken token)
//    {
//        int count = 0;
//        var start = DateTime.Now;
...
//            (await graphClient.Execute(cmd)).BeOk();
...
//    private async Task<int> AddNodesInBatch(IGraphClient graphClient, string prefix, CancellationToken token)
//    {
//        int count = 0;
//        var start = DateTime.Now;
...
//    private async Task<int> AddEdges(IGraphClient graphClient, string prefix, CancellationToken token)
//    {
//        int count = 0;
//        var start = DateTime.Now;
...
//    private async Task<int> AddNodesWithTags(IGraphClient graphClient, string prefix, CancellationToken token)
//    {
//        int count = 0;
//        var start = DateTime.Now;
...
//    private async Task<int> AddEdgesBatch(IGraphClient graphClient, string prefix, CancellationToken token)
//    {
//        int count = 0;
//        var start = DateTime.Now;
...
//    private async Task<int> AddEdgesWithTagsInBatch(IGraphClient graphClient, string prefix, CancellationToken token)
//    {
//        int count = 0;
//        var start = DateTime.Now;
...
//    private async Task<int> AddNodesWithData(IGraphClient graphClient, string prefix, CancellationToken token)
//    {
//        int count = 0;
//        var start = DateTime.Now;
