...
//        (await testClient.Execute($"delete (key={nodeKey});", NullScopeContext.Instance)).IsOk().Should().BeTrue();
...
//        var userOption = await testClient.Execute(userCmd, NullScopeContext.Instance);
...
//    {
//        var userOption = await testClient.Execute(cmd, NullScopeContext.Instance);
...
//    {
//        var result = await testClient.Execute(cmd, NullScopeContext.Instance);
//        result.IsOk().Should().BeTrue();
