...
//        list.Set(new PrincipalIdentity("id1", "nameIdentifier", "user1", "email@domain.com", false));
//        list.Count.Be(1);

//        list.Set(new PrincipalIdentity("id2", "nameIdentifier2", "user2", "email2@domain.com", false));
//        list.Count.Be(2);
...
//        Assert.ThrowsAny<Exception>(() => list.Set(invalid));
//    }
//}
