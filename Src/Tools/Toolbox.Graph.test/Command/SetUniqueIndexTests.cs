...
public class SetUniqueIndexTests
{
    ...
    public async Task SetMultipleIndexes()
    {
        ...
        var e1 = await testClient.Execute("set node key=node1 set t1=v1, t2=v2 index t1, t2 ;", NullScopeContext.Instance);
        ...
        var e2 = await testClient.Execute("set node key=node2 set t3=v3 index t3 ;", NullScopeContext.Instance);
    ...
    public async Task SetMultipleIndexesDifferentValue()
    {
        ...
        var e2 = await testClient.Execute("set node key=node2 set t1=v2 index t1 ;", NullScopeContext.Instance);
        e2.IsOk().Should().BeTrue(e1.ToString());
    ...
    public async Task SetUniqueIndexViolation()
    {
        ...
        var e2 = await testClient.Execute("set node key=node2 set t1=v1 index t1 ;", NullScopeContext.Instance);
    ...
    public async Task SetUniqueIndexViolation2()
    {
        ...
        var e2 = await testClient.Execute("set node key=node3 set t1=v2 index t1 ;", NullScopeContext.Instance);
        e2.IsOk().Should().BeTrue(e1.ToString());

        var e3 = await testClient.Execute("set node key=node2 set t1=v1 index t1 ;", NullScopeContext.Instance);
    ...
    public async Task SetAndUpdateIndex()
    {
        ...
        map.Nodes.LookupIndex("t1", "v2").IsError().Should().BeTrue();

        var e2 = await testClient.Execute("set node key=node1 set t1=v2 ;", NullScopeContext.Instance);
        e2.IsOk().Should().BeTrue(e1.ToString());

        map.Nodes.LookupIndex("t1", "v1").IsError().Should().BeTrue();
