...
//    {
//        var collection = new Dictionary2<int, TestRec>(x => x.Id);
...
//    {
//        var c = new Dictionary2<int, TestRec>(x => x.Id);
...
//        var c = new Dictionary2<string, TestRec>(x => x.Name, StringComparer.OrdinalIgnoreCase);
...
//    [Fact]
//    public void SerializationWithMultipleIndexes()
//    {
//        var c = new Dictionary2<int, TestRec>(x => x.Id);
...
//        var json = c.ToJson().NotEmpty();
//        c = json.ToObject<Dictionary2<int, TestRec>>();
