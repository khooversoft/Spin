...
//public class Dictionary2TrxRecorderTests
//{
//    private ITestOutputHelper _outputHelper;
//    private record MapRecord(string Name, int Age);

//    public Dictionary2TrxRecorderTests(ITestOutputHelper outputHelper) => _outputHelper = outputHelper;
...
//        ITrxProvider concurrentMap = new Dictionary2<string, string>(x => x);
...
//        var concurrentMap = new Dictionary2<string, string>(x => x);
//        concurrentMap.AttachRecorder(transaction.TrxRecorder);
//        await transaction.Start();
...
//        var concurrentMap = new Dictionary2<string, MapRecord>(x => x.Name);
//        concurrentMap.AttachRecorder(transaction.TrxRecorder);
//        await transaction.Start();
