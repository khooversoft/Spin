...
public class OptionConstructorTests
{
    ...
    public void DefaultConstructorOptionNoParameter()
    {
        ...
        option.StatusCode.Be(default);
        option.Error.BeNull();

        var option2 = new Option();
        (option == option2).BeTrue();
        (option != option2).BeFalse();
    }
    ...
    public void DefaultConstructorReferenceTypeNoParameter()
    {
        ...
        option.StatusCode.Be(default);
        option.Error.BeNull();
        option.HasValue.BeFalse();
        option.Value.Be(default);
        option.Return(false).Be(default);
    ...
    public void OptionValueTypeConstructorPattern1()
    {
        ...
        option.HasValue.BeFalse();
        option.StatusCode.Be(StatusCode.NoContent);
        option.Error.BeNull();
        option.Value.Be(default);
        option.Return(false).Be(default);
    ...
    public void OptionValueTypeConstructorPattern3()
    {
        ...
        option.HasValue.BeTrue();
        option.StatusCode.Be(StatusCode.Forbidden);
        option.Error.BeNull();
        option.Value.Be(10);
        option.Return().Be(10);
    ...
    public void OptionValueTypeConstructorPattern4()
    {
        ...
        option.HasValue.BeFalse();
        option.StatusCode.Be(StatusCode.NotFound);
        option.Error.BeNull();
        option.Value.Be(default);
        option.Return(false).Be(default);
    ...
    public void OptionValueTypeConstructorPattern6()
    {
        ...
        option.HasValue.BeTrue();
        option.StatusCode.Be(StatusCode.InternalServerError);
        option.Error.BeNull();
        option.Value.Be(15);
        option.Return().Be(15);
    ...
    public void OptionValueTypeConstructorPattern8()
    {
        ...
        option.HasValue.BeTrue();
        option.StatusCode.Be(StatusCode.NotFound);
        option.Error.Be("not found really");
        option.Value.Be(default);
        option.Return().Be(default);
