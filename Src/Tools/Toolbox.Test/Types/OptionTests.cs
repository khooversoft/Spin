...
public class OptionTests
{
    ...
    public void TestNone()
    {
        ...
        o2.Return().Should().Be(0);
        o2.StatusCode.Should().Be(StatusCode.OK);
        ...
        o3.StatusCode.Should().Be(StatusCode.OK);
    ...
    public void ValueTypes()
    {
        ...
        optionV1.StatusCode.Should().Be(StatusCode.OK);
    ...
    public void NullableValueWithNullTypes()
    {
        ...
        Option<long?> optionV1 = v1.ToOption();
        (optionV1 == default).Should().BeTrue();
        optionV1.StatusCode.Should().Be(StatusCode.NoContent);
    ...
    public void CollectionResponseValueType()
    {
        ...
        v2.StatusCode.Should().Be(StatusCode.OK);
        ...
        v4.StatusCode.Should().Be(StatusCode.OK);
    ...
    public void CollectionResponseCollectionType()
    {
        ...
        s3.Return(false).Should().Be(default);
