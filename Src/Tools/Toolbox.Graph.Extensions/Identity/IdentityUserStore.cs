...
//        user.NameIdentifier = login.LoginProvider;
...
//        if (result.NameIdentifier.IsEmpty() || result.ProviderKey.IsEmpty() || result.ProviderDisplayName.IsEmpty()) return Array.Empty<UserLoginInfo>();

//        var info = new UserLoginInfo(result.NameIdentifier, result.ProviderKey, result.ProviderDisplayName);
//        return [info];
//    }
